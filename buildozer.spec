...
source.include_exts = py,mp3,png,jpg,kv,atlas,ttf,html,pdf,jpeg, css, js
...
# (list) Permissions
android.permissions = android.permission.FOREGROUND_SERVICE, android.permission.INTERNET, android.permission.ACCESS_NETWORK_STATE
...
android.entrypoint = id.pbssi.jaya.WebLocalActivity

# (str) Full name including package path of the Java class that implements Android Activity
# use that parameter together with android.entrypoint to set custom Java class instead of PythonActivity
android.activity_class_name = id.pbssi.jaya.WebLocalActivity
...
android.service_class_name = id.pbssi.jaya.WebLocalService
